...
# instance fields
.field final bOU:Lrx/subscriptions/CompositeSubscription;

.field final bOV:Ljava/util/concurrent/ScheduledExecutorService;

.field final bmR:Ljava/util/concurrent/ConcurrentLinkedQueue;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Lrx/internal/c/c$a;->bmR:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lrx/internal/c/c$a;->bOU:Lrx/subscriptions/CompositeSubscription;

    .line 59
    invoke-static {}, Lrx/internal/c/d;->KM()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object p1

    iput-object p1, p0, Lrx/internal/c/c$a;->bOV:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final a(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;)Lrx/Subscription;
    ...
    .line 130
    iget-object v2, p0, Lrx/internal/c/c$a;->bOU:Lrx/subscriptions/CompositeSubscription;
    ...
    .line 162
    :try_start_0
    iget-object p1, p0, Lrx/internal/c/c$a;->bOV:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final b(Lrx/functions/Action0;)Lrx/Subscription;
    ...
    iget-object v1, p0, Lrx/internal/c/c$a;->bOU:Lrx/subscriptions/CompositeSubscription;

    invoke-direct {v0, p1, v1}, Lrx/internal/c/j;-><init>(Lrx/functions/Action0;Lrx/subscriptions/CompositeSubscription;)V

    .line 71
    iget-object p1, p0, Lrx/internal/c/c$a;->bOU:Lrx/subscriptions/CompositeSubscription;

    invoke-virtual {p1, v0}, Lrx/subscriptions/CompositeSubscription;->add(Lrx/Subscription;)V

    .line 72
    iget-object p1, p0, Lrx/internal/c/c$a;->bmR:Ljava/util/concurrent/ConcurrentLinkedQueue;
...
.method public final isUnsubscribed()Z
    ...
    .line 179
    iget-object v0, p0, Lrx/internal/c/c$a;->bOU:Lrx/subscriptions/CompositeSubscription;
...
.method public final run()V
    ...
    .line 98
    iget-object v0, p0, Lrx/internal/c/c$a;->bmR:Ljava/util/concurrent/ConcurrentLinkedQueue;
