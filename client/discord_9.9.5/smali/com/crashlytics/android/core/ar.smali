...
# static fields
.field static final tU:Ljava/util/Map;
...
.field private static final tV:[S


# instance fields
.field private final qw:Ljava/lang/String;

.field private final rQ:Lcom/crashlytics/android/core/ar$c;

.field private final rR:Lcom/crashlytics/android/core/ar$b;

.field private final tW:Ljava/lang/Object;

.field private final tX:Lcom/crashlytics/android/core/v;

.field private tY:Ljava/lang/Thread;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/crashlytics/android/core/ar;->tU:Ljava/util/Map;
    ...
    sput-object v0, Lcom/crashlytics/android/core/ar;->tV:[S
...
.method public constructor <init>(Ljava/lang/String;Lcom/crashlytics/android/core/v;Lcom/crashlytics/android/core/ar$c;Lcom/crashlytics/android/core/ar$b;)V
    ...
    iput-object v0, p0, Lcom/crashlytics/android/core/ar;->tW:Ljava/lang/Object;

    if-eqz p2, :cond_0

    .line 72
    iput-object p2, p0, Lcom/crashlytics/android/core/ar;->tX:Lcom/crashlytics/android/core/v;

    .line 73
    iput-object p1, p0, Lcom/crashlytics/android/core/ar;->qw:Ljava/lang/String;

    .line 74
    iput-object p3, p0, Lcom/crashlytics/android/core/ar;->rQ:Lcom/crashlytics/android/core/ar$c;

    .line 75
    iput-object p4, p0, Lcom/crashlytics/android/core/ar;->rR:Lcom/crashlytics/android/core/ar$b;
...
.method static synthetic a(Lcom/crashlytics/android/core/ar;)Ljava/lang/Thread;
    ...
    .line 20
    iput-object v0, p0, Lcom/crashlytics/android/core/ar;->tY:Ljava/lang/Thread;
...
.method static synthetic b(Lcom/crashlytics/android/core/ar;)Lcom/crashlytics/android/core/ar$b;
    ...
    .line 20
    iget-object p0, p0, Lcom/crashlytics/android/core/ar;->rR:Lcom/crashlytics/android/core/ar$b;

    return-object p0
.end method

.method static synthetic dp()[S
    .locals 1

    .line 20
    sget-object v0, Lcom/crashlytics/android/core/ar;->tV:[S
...
.method public final declared-synchronized a(FLcom/crashlytics/android/core/ar$d;)V
    ...
    .line 79
    :try_start_0
    iget-object v0, p0, Lcom/crashlytics/android/core/ar;->tY:Ljava/lang/Thread;
    ...
    iput-object p1, p0, Lcom/crashlytics/android/core/ar;->tY:Ljava/lang/Thread;

    .line 86
    iget-object p1, p0, Lcom/crashlytics/android/core/ar;->tY:Ljava/lang/Thread;
...
.method final a(Lcom/crashlytics/android/core/aq;)Z
    ...
    .line 101
    iget-object v0, p0, Lcom/crashlytics/android/core/ar;->tW:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/crashlytics/android/core/ar;->qw:Ljava/lang/String;

    invoke-direct {v2, v3, p1}, Lcom/crashlytics/android/core/u;-><init>(Ljava/lang/String;Lcom/crashlytics/android/core/aq;)V

    .line 104
    iget-object v3, p0, Lcom/crashlytics/android/core/ar;->tX:Lcom/crashlytics/android/core/v;
    ...
    .line 106
    invoke-interface {v3, v4, v5}, Lio/fabric/sdk/android/l;->Z(Ljava/lang/String;Ljava/lang/String;)V
...
.method final do()Ljava/util/List;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 128
    :try_start_0
    iget-object v1, p0, Lcom/crashlytics/android/core/ar;->rQ:Lcom/crashlytics/android/core/ar$c;

    invoke-interface {v1}, Lcom/crashlytics/android/core/ar$c;->cM()[Ljava/io/File;

    move-result-object v1

    .line 129
    iget-object v2, p0, Lcom/crashlytics/android/core/ar;->rQ:Lcom/crashlytics/android/core/ar$c;

    invoke-interface {v2}, Lcom/crashlytics/android/core/ar$c;->cN()[Ljava/io/File;

    move-result-object v2

    .line 130
    iget-object v3, p0, Lcom/crashlytics/android/core/ar;->rQ:Lcom/crashlytics/android/core/ar$c;

    invoke-interface {v3}, Lcom/crashlytics/android/core/ar$c;->cO()[Ljava/io/File;
    ...
    invoke-interface {v8, v10, v9}, Lio/fabric/sdk/android/l;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v6, v8, v7}, Lio/fabric/sdk/android/l;->d(Ljava/lang/String;Ljava/lang/String;)V
