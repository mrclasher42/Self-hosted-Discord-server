...
.method private performExtractions()Ljava/util/List;
    ...
    iget-object v6, p0, Landroidx/multidex/MultiDexExtractor;->sourceApk:Ljava/io/File;
    ...
    .line 272
    invoke-static {v5, v7, v9, v3}, Landroidx/multidex/MultiDexExtractor;->extract(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 276
    :try_start_1
    invoke-static {v9}, Landroidx/multidex/MultiDexExtractor;->getZipCrc(Ljava/io/File;)J

    move-result-wide v11

    iput-wide v11, v9, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->crc:J
    :try_end_1
    ...
    invoke-virtual {v9}, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->getAbsolutePath()Ljava/lang/String;
    ...
    invoke-static {v2, v12, v11}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .line 286
    invoke-virtual {v9}, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->length()J
    ...
    .line 289
    invoke-virtual {v9}, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->delete()Z

    .line 290
    invoke-virtual {v9}, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->exists()Z
    ...
    .line 292
    invoke-virtual {v9}, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->getPath()Ljava/lang/String;
